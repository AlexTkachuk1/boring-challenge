...
export class SoundManager {
    ...
    public initSounds(): void {
        this._ambientSound = this._scene.sound.add(AudioKeys.Ambient, { loop: true, volume: this._musicVolume });
        this._ambientSound.play();
        this.spinSound = this._scene.sound.add(AudioKeys.Spin, { loop: false, volume: this._soundsVolume });
        this.clickSound = this._scene.sound.add(AudioKeys.Click, { loop: false, volume: this._soundsVolume });
        this.winSound = this._scene.sound.add(AudioKeys.WinSound, { loop: false, volume: this._soundsVolume });
    }
