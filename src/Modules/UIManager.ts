...
export class UIManager {
    ...
    public initSpinButton(): void {
        this.spinButton = this._scene.add.image(512, 630, ArtKeys.Button)
            .setDepth(2)
            .setInteractive()
            .on('pointerover', () => {
    ...
    public createVolumeControls(): void {
        this._sountButton = this._scene.add.image(70, 70, ArtKeys.SoundButtonDefault)
        .setDepth(2)
        .setInteractive()
        .on('pointerover', () => {
        ...
        this._soundIcon = this._scene.add.image(70, 65, ArtKeys.SoundOnIcon).setDepth(2);
    }
    ...
    public toggleSoundButton(active: boolean): void {
        active ? this._soundIcon.setTexture(ArtKeys.SoundOnIcon) : this._soundIcon.setTexture(ArtKeys.SoundOffIcon);
    }
}